            ...
            case 4:
              ...
              if (
                !_fs["default"].existsSync(
                  _path["default"].resolve(DEFAULT_CONFIG_PATH)
                )
              ) {
                _context.next = 9;
                break;
            ...
            case 9:
              ...
              throw new Error(
                "next-i18next was unable to find a user config :: " +
                  _path["default"].resolve(DEFAULT_CONFIG_PATH) +
                  " :: " +
                  _fs["default"].readdirSync(_path["default"].resolve("./src"))
              );

            case 11:
              config = (0, _createConfig.createConfig)(
                _objectSpread(
                  _objectSpread({}, userConfig),
                  {},
                  {
                    lng: initialLocale,
                  }
              ...
              (defaultLocale = config.defaultLocale),
                (localeExtension = config.localeExtension),
                (localePath = config.localePath);
              (_createClient = (0, _createClient2["default"])(
                _objectSpread(
                ...
                (initPromise = _createClient.initPromise);
              _context.next = 16;
              return initPromise;

            case 16:
              initialI18nStore = (0, _defineProperty2["default"])(
                {},
                initialLocale,
                {}
              );
              ...
              if (namespacesRequired.length === 0) {
                ...
                namespacesRequired = getAllNamespaces(
                  _path["default"].resolve(
                    process.cwd(),
                    "".concat(localePath, "/").concat(defaultLocale)
                  )
                );
              }
